...
# Calibration and diagnostic metrics

Milestone 5 adds Brier score, log loss, ECE, MCE, calibration slope/intercept and bin observations; subgroup classification/probability metrics; repeated permutation deterioration; and validation threshold comparisons. Small/one-class subgroup metrics are suppressed.

...
public sealed record RealProtocolDocument(string ProtocolCode, string ProtocolVersion, string Title, string ResearchQuestion, JsonElement StudyPeriod, string Population, string DrugIdentityPolicy, string StateEligibilityPolicy, string TerritoryPolicy, string EntryDefinition, JsonElement DistributionDefinitions, JsonElement Predictive, JsonElement Causal, JsonElement DataPolicies, JsonElement SensitivityAnalyses, JsonElement LeakagePrevention, JsonElement Exclusions, string ProtocolDeviationPolicy, string HumanApproval, JsonElement ReferenceIds, string[] RemainingReviewQuestions);

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatmentValue = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: false),
                    ...
                    PropensityScore = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    OutcomeRegressionTreated = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    OutcomeRegressionUntreated = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    InfluenceFunctionValue = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    Weight = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estimate = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: false),
                    StandardError = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    ConfidenceIntervalLower = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    ConfidenceIntervalUpper = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    PValue = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    BootstrapRepetitions = table.Column<int>(type: "int", nullable: true),
                    EffectiveSampleSize = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaselinePredictedOutcome = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: false),
                    InterventionPredictedOutcome = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: false),
                    EstimatedDifference = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: false),
                    UncertaintyLower = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),
                    UncertaintyUpper = table.Column<double>(type: "float(20)", precision: 20, scale: 10, nullable: true),

...
public sealed class ModelMetadataTests
{
    ...
    [InlineData(typeof(OrangeBookSnapshotEntity), "OrangeBookSnapshot", "reference")]
    [InlineData(typeof(OrangeBookProductEntity), "OrangeBookProduct", "reference")]
    [InlineData(typeof(DrugsFdaSnapshotEntity), "DrugsFdaSnapshot", "reference")]
    [InlineData(typeof(DrugsFdaApplicationEntity), "DrugsFdaApplication", "reference")]
    [InlineData(typeof(DrugsFdaProductEntity), "DrugsFdaProduct", "reference")]
    [InlineData(typeof(DrugsFdaMarketingStatusEntity), "DrugsFdaMarketingStatus", "reference")]
    [InlineData(typeof(DrugsFdaTherapeuticEquivalenceEntity), "DrugsFdaTherapeuticEquivalence", "reference")]
    [InlineData(typeof(NdcDirectorySnapshotEntity), "NdcDirectorySnapshot", "reference")]
    [InlineData(typeof(NdcDirectoryProductEntity), "NdcDirectoryProduct", "reference")]
    [InlineData(typeof(NdcDirectoryPackageEntity), "NdcDirectoryPackage", "reference")]
    [InlineData(typeof(RxNormSnapshotEntity), "RxNormSnapshot", "reference")]
    [InlineData(typeof(RxNormConceptEntity), "RxNormConcept", "reference")]
    [InlineData(typeof(RxNormNdcAssociationEntity), "RxNormNdcAssociation", "reference")]
    [InlineData(typeof(ProductFamilyIdentityEntity), "ProductFamilyIdentity", "reference")]
    [InlineData(typeof(ProductMappingEvidenceEntity), "ProductMappingEvidence", "reference")]
